CREATE TYPE "public"."barang_hilang_priority" AS ENUM('low', 'medium', 'high');--> statement-breakpoint
CREATE TYPE "public"."barang_hilang_status" AS ENUM('pending_verification', 'in_verification', 'processing', 'resolved', 'rejected', 'archived');--> statement-breakpoint
ALTER TYPE "public"."service_request_type" ADD VALUE 'BANSOS_APPLICATION';--> statement-breakpoint
...
--> statement-breakpoint
DROP INDEX "household_members_citizen_id_idx";--> statement-breakpoint
ALTER TABLE "bansos_programs" ADD CONSTRAINT "bansos_programs_created_by_user_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."user"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "barang_hilang" ADD CONSTRAINT "barang_hilang_reporter_id_user_id_fk" FOREIGN KEY ("reporter_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "barang_hilang" ADD CONSTRAINT "barang_hilang_handled_by_user_id_fk" FOREIGN KEY ("handled_by") REFERENCES "public"."user"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "bansos_programs_created_by_idx" ON "bansos_programs" USING btree ("created_by");--> statement-breakpoint
...
CREATE INDEX "pemilu_events_created_by_idx" ON "pemilu_events" USING btree ("created_by");--> statement-breakpoint
CREATE INDEX "barang_hilang_reporter_idx" ON "barang_hilang" USING btree ("reporter_id");--> statement-breakpoint
CREATE INDEX "barang_hilang_status_idx" ON "barang_hilang" USING btree ("status");--> statement-breakpoint
CREATE INDEX "barang_hilang_ticket_idx" ON "barang_hilang" USING btree ("ticket_number");--> statement-breakpoint
